...
img = np.ones((512,512,3),np.uint8) * 255#背景为白色
...
cv2.circle(img,(181,228),25,(255,255,255),-1)
...
#三角形填充
cv2.fillPoly(img,[t1,t2,t3],(255,255,255))

#添加文字
font = cv2.FONT_HERSHEY_SIMPLEX
cv2.putText(img,'OpenCv',(130,400),font,2,(0,0,0),5,cv2.LINE_AA)
